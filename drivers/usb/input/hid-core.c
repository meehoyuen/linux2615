...
#define HID_QUIRKS_UGCI		\
	(HID_QUIRK_BADPAD | HID_QUIRK_MULTI_INPUT | HID_QUIRK_NO_CLEAR_HALT)
...
static struct hid_blacklist {
	...
	{ USB_VENDOR_ID_MGE, USB_DEVICE_ID_MGE_UPS1, HID_QUIRK_IGNORE },
 	{ USB_VENDOR_ID_SYNAPTICS, USB_DEVICE_ID_CPAD, HID_QUIRK_IGNORE },
	...
	{ USB_VENDOR_ID_HAPP, USB_DEVICE_ID_UGCI_DRIVING, HID_QUIRKS_UGCI },
	{ USB_VENDOR_ID_HAPP, USB_DEVICE_ID_UGCI_FLYING, HID_QUIRKS_UGCI },
	{ USB_VENDOR_ID_HAPP, USB_DEVICE_ID_UGCI_FIGHTING, HID_QUIRKS_UGCI },
...
static struct hid_device *usb_hid_configure(struct usb_interface *intf)
{
	...
	if (!(quirks & HID_QUIRK_NO_CLEAR_HALT))
