...
static int __init kick_interrupts(struct dmi_system_id *d)
{
	pata_ack_interrupts = 1;
	return 0;
};

static struct dmi_system_id __initdata ide_dmi_table[] = {
	{
		kick_interrupts, "Apple",
...
#ifdef CONFIG_X86
	dmi_check_system(ide_dmi_table);
#endif
