...
#define ACPI_PCC_VERSION	"0.8.2+hy $Id: pcc_acpi.c,v 1.10 2006/01/25 13:23:18 elca Exp $"
 ...
 * Supported devices
 ****************************************************/
static const struct pnp_device_id __devinitdata acpi_pcc_pnp_table[] = {
	/* Panasonic Let's note */
	{.id = "MAT0012", .driver_data = 0}, /* ???   */
	{.id = "MAT0013", .driver_data = 0}, /* ???   */
	{.id = "MAT0018", .driver_data = 0}, /* ???   */
	{.id = "MAT0019", .driver_data = 0}, /* CF-R3 */
	{ },
};
MODULE_DEVICE_TABLE(pnp,acpi_pcc_pnp_table);
...
/* ----------------------------------------------------------------------
   ISAPNP
   ---------------------------------------------------------------------- */
static int __devinit acpi_pcc_pnp_probe(struct pnp_dev * dev, const struct pnp_device_id *dev_id)
{
	int result;
...
static void __devexit acpi_pcc_pnp_remove(struct pnp_dev * dev)
{
	acpi_bus_unregister_driver(&acpi_pcc_driver);
}

static struct pnp_driver acpi_pcc_pnp_driver = {
	.name     = "pcc_acpi",
	.id_table = acpi_pcc_pnp_table,
	.probe    = acpi_pcc_pnp_probe,
	.remove   = __devexit_p(acpi_pcc_pnp_remove),
};
...
static int __init acpi_pcc_init(void)
{
	...
	return_VALUE(pnp_register_driver(&acpi_pcc_pnp_driver));
}
...
static void __exit acpi_pcc_exit(void)
{
	...
	pnp_unregister_driver(&acpi_pcc_pnp_driver);
